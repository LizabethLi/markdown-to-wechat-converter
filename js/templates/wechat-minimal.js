...
(function() {
    ...
    const MinimalTemplate = {
        ...
        compact: {
            ...
            h1: (_m, text) =>
                `<section style="padding-top:60px;margin:0 0 10px;"><h1 style="font-size:22px;margin:0;line-height:1.3;color:#111;border-left:4px solid {{THEME_COLOR}};padding-left:10px;">${text}</h1></section>`,
        ...
        getStyles(mode, themeColor) {
            ...
            if (!this.standard || !this.standard.h1) {
                ...
                this.standard = {
                    ...
                    h1: (_m, t) => `<section style="padding-top:64px;margin:0 0 12px;"><h1 style="font-size:24px;margin:0;line-height:1.35;color:#111;border-left:5px solid {{THEME_COLOR}};padding-left:12px;">${t}</h1></section>`,
