...
const WechatStyles = {
    ...
    compact: {
        ...
        h1: (match, text, index) => {
            ...
            return `<section style="text-align: center; margin: 0 0 14px 0; padding-top: 44px;">${numberLine}${titleLine}</section>`;
        },
    ...
    standard: {
        ...
        h1: (match, text, index) => {
            ...
            return `<section style="text-align: center; margin: 0 0 20px 0; padding-top: 48px;">${numberLine}${titleLine}</section>`;
        },
